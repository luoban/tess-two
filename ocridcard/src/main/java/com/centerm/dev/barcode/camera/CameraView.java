...
import com.centerm.dev.barcode.camera.base.Camera14;
import com.centerm.dev.barcode.camera.base.CameraViewImpl;
import com.centerm.dev.barcode.camera.base.Constants;
import com.centerm.dev.barcode.camera.base.PreviewImpl;
import com.centerm.dev.barcode.camera.base.SurfaceViewPreview;
import com.centerm.dev.barcode.camera.base.TextureViewPreview;
...
//        if (Build.VERSION.SDK_INT < 21) {//硬件不支持camera2
        mImpl = new Camera14(mCallbacks, preview);
//        } else if (Build.VERSION.SDK_INT < 23) {
//          mImpl = new Camera21(mCallbacks, preview, context);
//        } else {
...
//        }
    ...
    public void start() {
        if (!mImpl.start()) {
            ...
            mImpl = new Camera14(mCallbacks, createPreviewImpl(getContext()));
    ...
    private class CallbackBridge implements CameraViewImpl.Callback {
        ...
        @Override
        public void onPreviewCallback(byte[] yuv) {
            for (Callback callback : mCallbacks) {
                callback.onPreviewCallback(CameraView.this, yuv);
            }
        }
        ...
        public void onPreviewCallback(Bitmap bmp) {
            for (Callback callback : mCallbacks) {
                callback.onPreviewCallback(CameraView.this, bmp);
            }
        }
