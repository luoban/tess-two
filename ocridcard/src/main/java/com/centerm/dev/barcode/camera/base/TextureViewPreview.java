...
public class TextureViewPreview extends PreviewImpl {
    ...
    public TextureViewPreview(Context context, ViewGroup parent) {
        Point point = CameraManager.get().getPreviewSize();
        mCacheBmp = Bitmap.createBitmap(point.y, point.x, Bitmap.Config.ARGB_4444);
        ...
        mTextureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() {
            ...
            public void onSurfaceTextureUpdated(SurfaceTexture surface) {
                if (CameraManager.get().getScanMode() == CameraManager.MODE_HIGHER_ACCURATE) {
                    dispatchSurfaceUpdated(mTextureView.getBitmap(mCacheBmp));
                }
            }
        });
    }
